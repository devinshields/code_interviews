#!/usr/bin/env python
'''
https://en.wikipedia.org/wiki/Interval_tree#Naive_approach
https://raw.githubusercontent.com/tylerkahn/intervaltree-python/master/IntervalTree.py
http://hackmap.blogspot.com/2008/11/python-interval-tree.html

  - with non-overlapping intervals and when searching for a single point
      - can use a simple BST
      - tweaked to return "in-range" bools rather than a node values
  
  - overlapping intervals require a fancier algorithm
      - gets complex quick
